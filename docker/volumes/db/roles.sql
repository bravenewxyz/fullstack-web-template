-- Minimal Supabase roles initialization for GoTrue
-- This creates the bare minimum for GoTrue to start and run its own migrations
...
-- Set search_path to auth schema so GoTrue can find its tables
